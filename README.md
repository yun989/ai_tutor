...
This project is provided **"as is"**, without warranty of any kind. By using this application, you acknowledge and agree to the following:

- **API Costs**: This application uses Google's Gemini API under a Bring Your Own Key (BYOK) model. You are solely responsible for any costs or charges incurred by your API key usage. The developer of this project is not liable for any fees from Google.
- **AI Accuracy**: The English teaching content generated by AI may contain inaccuracies. This tool is intended as a supplementary learning aid and should not be relied upon as a sole source of language instruction.
- **Audio & Privacy**: When using the Live Voice Mode, your microphone audio is streamed directly to Google's servers for processing via the Gemini Live API. No audio data is stored or collected by this application, but Google's own [Privacy Policy](https://policies.google.com/privacy) and [Terms of Service](https://policies.google.com/terms) apply.
